<template>
	<view>
		...
		<view class="box-1" id="list-box">
			<view class="talk-list">
				<view >
					<view class="item flex_col push">
						<image src="../../static/image1.png" mode="aspectFill" class="pic"></image>
						<view class="content">
			...
			<view class="talk-list">
				<view >
					<view class="item flex_col push">
						<image src="../../static/image1.png" mode="aspectFill" class="pic"></image>
						<view class="content">
							<phordermsg :cosordermsg='cosordermsg[0]' :acceptOrder='acceptOrder' :refuseOrder='refuseOrder'></phordermsg>
						</view>
					</view>
				</view>
			</view>
